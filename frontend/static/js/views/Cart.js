...
export default class extends AbstractView {
  ...
  handleCart() {
    ...
    for (const id in cart) {
      ...
      cardImage.src = produtos[id].urlImage;
      ...
      cardTitle.innerHTML = produtos[id].nome;

      let cardDescription = document.createElement("p");
      cardDescription.classList.add("long-text");
      cardDescription.innerHTML = produtos[id].descricao;
      ...
      cardValue.innerHTML = "Valor: R$ " + produtos[id].valor;
      ...
      cardTotal.innerHTML =
        "Total: R$ " +
        Math.round(cart[id].quantidade * produtos[id].valor * 100) / 100;
      totalPayment += cart[id].quantidade * produtos[id].valor;
